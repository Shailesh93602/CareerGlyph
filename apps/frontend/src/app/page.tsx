      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-500 mb-12 max-w-2xl mx-auto">
            Replace static resumes with dynamic, verifiable, interactive
            profiles that showcase real skills, projects, and achievements.
          </p>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-600">
              Import from GitHub, LinkedIn, and more. AI generates professional
              summaries and skill matrices.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-600">
              Showcase real code with auto-generated portfolio cards, tech
              stacks, and live demos.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-600">
              AI-powered fit analysis helps recruiters quickly assess candidate
